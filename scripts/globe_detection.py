"""
Globe Shape Detection - Detect and recognize shapes in globe image
...
def analyze_globe_shapes(image_path):
    """Analyze and detect shapes in globe image"""
    print(f"\n{'='*60}")
    print(f"GLOBE SHAPE DETECTION ANALYSIS")
    print(f"{'='*60}")
    ...
    fig.suptitle('Globe Shape Detection Analysis', fontsize=16, fontweight='bold')
...
if __name__ == "__main__":
    # Process globe image
    image_path = Path("images/globe.jpg")
    if image_path.exists():
        analyze_globe_shapes(image_path)
    else:
